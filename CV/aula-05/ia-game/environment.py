...
class Environment():
    ...
    def __init__(self, waitTime):
        ...
        self.defReward = -0.10      # reward for taking an action - The Living Penalty
    ...
    def drawScreen(self):
        ...
        for i in range(self.nRows):
            for j in range(self.nColumns):
                ...
                if i == snakeY and j == snakeX:
                    pg.draw.rect(self.screen, (0, 0, 255), (j*cellWidth + 1, i*cellHeight + 1, cellWidth - 2, cellHeight - 2))
